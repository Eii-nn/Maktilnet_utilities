...
/interface ovpn-client add cipher=aes256-gcm connect-to=preflightvpn.apolloglobal.net port=1194 mode=ip name=preflight-ovpn password=PREfl1ght@ovpn@2k26Access user=preflightuser certificate=none verify-server-certificate=no auth=sha1 use-peer-dns=yes add-default-route=no
